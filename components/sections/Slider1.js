                                        ...
                                        <SwiperSlide>
                                            <div className="tp-slide-item">
                                                <div className="tp-slide-item__content">
                                                    <h4 className="tp-slide-item__sub-title">Your Trusted Full-Line</h4>
                                                    <h3 className="tp-slide-item__title mb-25">
                                                        <i>Wholesale Supplier
                                                            {/* <img src="/assets/img/icon/title-shape-02.jpg" alt="" /> */}
                                                        </i>
                                                        <br />
                                                        Serving Restaurants & Homes in Los Angeles, CA
                                                    </h3>
                                                ...
                                                <div className="tp-slide-item__img">
                                                    <img src="/assets/img/slider/banner1.jpeg" alt="" />
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="tp-slide-item">
                                                <div className="tp-slide-item__content">
                                                    <h4 className="tp-slide-item__sub-title">Your Trusted Full-Line</h4>
                                                    <h3 className="tp-slide-item__title mb-25"> <i>Wholesale Supplier </i><br />
                                                    Serving Restaurants & Homes in Los Angeles, CA</h3>
                                                    <Link className="tp-slide-item__slide-btn tp-btn" href="#">Shop Now <i className="fal fa-long-arrow-right" /></Link>
                                                </div>
                                                <div className="tp-slide-item__img">
